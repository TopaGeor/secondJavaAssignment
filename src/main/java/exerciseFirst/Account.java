...
public class Account {
    ...
    public void testMethods(){
        ...
        if (deposit(testAmount)) {
            System.out.println("Success you manage to deposit: " + testAmount);
        }
        else {
            System.out.println("Failed at deposing: " + testAmount);
        }
        ...
        System.out.println("The result should be a success");
        if (withdraw(testAmount)) {
            System.out.println("Success you manage to withdraw: " + testAmount);
        } else {
            System.out.println("Failed at withdrawing: " + testAmount);
        }
